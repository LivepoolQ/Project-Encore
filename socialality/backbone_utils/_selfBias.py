...
@LastEditTime: 2026-07-23 19:05:29
...
class SelfBiasLayer(torch.nn.Module):
    ...
    def __init__(self, Args: Args,
        ...
        self.args = Args
        self.sa_args = self.args.register_subargs(SocialalityArgs, 'sa_args')
        ...
        self.ms_fc = layers.Dense(self.d, self.sa_args.generation_num, torch.nn.Tanh)
